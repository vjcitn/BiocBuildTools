...
td = "~/BBS_space/NOV5_FULL/fullgits_nov10"  # updated nov15 with update_gits.R
...
if (!dir.exists("~/BBS_space/NOV22_FULL")) dir.create("~/BBS_space/NOV22_FULL")
chkdest = "~/BBS_space/NOV22_FULL/rchk"
if (!dir.exists(chkdest)) dir.create(chkdest)

bdest = "~/BBS_space/NOV22_FULL/bchk"
if (!dir.exists(bdest)) dir.create(bdest)

bobdest = "~/BBS_space/NOV22_FULL/bobs"
...
build_sqlite_db("biocfull11.sqlite", rcmd=chkdest, bcc=bobdest)
