...
if (!dir.exists("~/BBS_space/NOV15_FULL")) dir.create("~/BBS_space/NOV15_FULL")
chkdest = "~/BBS_space/NOV15_FULL/rchk"
if (!dir.exists(chkdest)) dir.create(chkdest)

bdest = "~/BBS_space/NOV15_FULL/bchk"
if (!dir.exists(bdest)) dir.create(bdest)

bobdest = "~/BBS_space/NOV15_FULL/bobs"
...
build_sqlite_db("biocfull7.sqlite", rcmd=chkdest, bcc=bobdest)
